                                    ...
                                    {locations.map((loc) => {
                                        return (
                                            <Link
                                                key={loc.id}
                                                href={`/${loc.slug}`}
                                                className="text-left px-6 py-4 font-semibold text-gray-500 hover:bg-gray-50 hover:text-[#1A1D23] text-sm transition-all whitespace-nowrap md:whitespace-normal shrink-0 border-b-4 md:border-b-0 md:border-l-[4px] border-transparent"
                                            >
                                                {loc.district}
                                            </Link>
                                        );
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 shrink-0">
                                <a
                                    ...
                                    className="w-full sm:w-[240px] h-[56px] bg-white text-[#38b000] rounded-xl font-bold flex items-center justify-center gap-3 shadow-lg hover:bg-gray-50 transition-colors px-5"
                                >
