    ...
    return (
        <section className="py-20 bg-accent/10 px-4">
            <div className="container mx-auto max-w-5xl">
                <motion.div
                    className="bg-gradient-to-br from-primary to-[#e65c00] rounded-[2.5rem] p-12 md:p-20 text-center shadow-xl shadow-primary/20 relative overflow-hidden"
                ...
                >
                    ...
                    <div className="relative z-10 space-y-8">
                        ...
                        <p className="text-white/90 text-lg max-w-2xl mx-auto">
                            İhtiyacınıza en uygun forklift veya manitou modelini belirlemek için uzman ekibimizle iletişime geçin.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-4">
                            ...
                            >
                                <Button size="lg" className="cursor-pointer w-full sm:w-[240px] h-[56px] bg-white text-orange-600 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-gray-100 transition-transform hover:scale-105 text-base">
